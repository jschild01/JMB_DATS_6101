...
creditfit <- rpart(credit.policy ~ purpose	+ int.rate + installment + log.annual.inc	+ dti	+ fico + days.with.cr.line + 	revol.bal	+ revol.util + inq.last.6mths	+ delinq.2yrs + pub.rec + not.fully.paid + has.delinq.2yrs + has.pub.rec + log.revol.bal + has.revol.bal, data = loans_tree, cp=.01, method="class", contro=list(maxdepth=4))
