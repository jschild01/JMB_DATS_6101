...
Just to note here since none of the relationships are linear. This means we can build a multiple linear model with the variables as multicolinearity is not going to be an issue.
