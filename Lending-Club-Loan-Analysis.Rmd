...
plot(loans$int.rate,loans$delinq.2yrss)
...
plot(loans$installment,loans$delinq.2yrss)
plot(loans$installment,loans$pub.rec)
plot(loans$log.annual.inc,loans$dti)
plot(loans$log.annual.inc,loans$fico)
plot(loans$log.annual.inc,loans$days.with.cr.line)
plot(loans$log.annual.inc,loans$revol.bal)
plot(loans$log.annual.inc,loans$revol.util)
plot(loans$log.annual.inc,loans$inq.last.6mths)
plot(loans$log.annual.inc,loans$delinq.2yrss)
plot(loans$log.annual.inc,loans$pub.rec)
...
plot(loans$dti,loans$delinq.2yrs)
...
plot(loans$fico,loans$delinq.2yrs)
