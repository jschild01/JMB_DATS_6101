...
<<<<<<< HEAD
We can perform t-interval tests for each numeric variable in our dataset. Not all of the results may be useful, but we want to have them available for further consideration.

=======
## T-tests:
>>>>>>> fe57b78a10f8ebd58b427a3528031f5265cc6498
```{r results = "show"}
...
=======
The `purpose` variable in our data is a good candidate to perform ANOVA tests with. We will do an ANOVA test for each variable based on `purpose`.We will also be doing Tuckey tests here .
>>>>>>> fe57b78a10f8ebd58b427a3528031f5265cc6498
...
=======
The `credit.policy` variable in our data is a good candidate to perform ANOVA tests with. We will do an ANOVA test for each variable based on `credit.policy`.We will not be doing Tuckey tests here .
...
The `not.fully.paid` variable in our data is a good candidate to perform ANOVA tests with. We will do an ANOVA test for each variable based on `not.fully.paid`.We will not be doing Tuckey tests here .
```{r results = "show"}
...
We want to create a Q-Q plot for each numeric variable so we can perform a normality test for each.
...
While the annual income data was given to us as a log, the revolving balance was given to use unmodified. We discovered that taking the log of of the `revol.bal` variable gives a better result that looks more normal, but encountered an issue. There are some loans with `revol.bal` value of 0, and when you take the log of that you get -Inf. We will need to decide how to handle this in the future. Fow now, we want to demonstrate the results of taking the log of `revol.bal`.
...
<<<<<<< HEAD
We performed z-interval tests for each variable, but decided that t-interval was more appropriate. We are keeping the code here so that we don't lose the work.
...
## Scatter-plots:
```{r}
plot(loans$int.rate,loans$installment,pch=1,col='pink')
plot(loans$int.rate,loans$log.annual.in,pch=1,col='pink')
plot(loans$int.rate,loans$dti,pch=1,col='pink')
plot(loans$int.rate,loans$fico,pch=1,col='pink')
plot(loans$int.rate,loans$days.with.cr.line,pch=1,col='pink')
plot(loans$int.rate,loans$revol.bal,pch=1,col='pink')
plot(loans$int.rate,loans$revol.util,pch=1,col='pink')
plot(loans$int.rate,loans$inq.last.6mths,pch=1,col='pink')
plot(loans$int.rate,loans$delinq.2yr,pch=1,col='pink')
plot(loans$int.rate,loans$pub.rec,pch=1,col='pink')
plot(loans$installment,loans$log.annual.in,pch=1,col='pink')
plot(loans$installment,loans$dti,pch=1,col='pink')
plot(loans$installment,loans$fico,pch=1,col='pink')
plot(loans$installment,loans$days.with.cr.line,pch=1,col='pink')
plot(loans$installment,loans$revol.bal,pch=1,col='pink')
plot(loans$installment,loans$revol.util,pch=1,col='pink')
plot(loans$installment,loans$inq.last.6mths,pch=1,col='pink')
plot(loans$installment,loans$delinq.2yr,pch=1,col='pink')
plot(loans$installment,loans$pub.rec,pch=1,col='pink')
plot(loans$log.annual.inc,loans$dti,pch=1,col='pink')
plot(loans$log.annual.inc,loans$fico,pch=1,col='pink')
plot(loans$log.annual.inc,loans$days.with.cr.line,pch=1,col='pink')
plot(loans$log.annual.inc,loans$revol.bal,pch=1,col='pink')
plot(loans$log.annual.inc,loans$revol.util,pch=1,col='pink')
plot(loans$log.annual.inc,loans$inq.last.6mths,pch=1,col='pink')
plot(loans$log.annual.inc,loans$delinq.2yrs,pch=1,col='pink')
plot(loans$log.annual.inc,loans$pub.rec,pch=1,col='pink')
plot(loans$dti,loans$fico,pch=1,col='pink')
plot(loans$dti,loans$days.with.cr.line,pch=1,col='pink')
plot(loans$dti,loans$revol.bal,pch=1,col='pink')
plot(loans$dti,loans$revol.util,pch=1,col='pink')
plot(loans$dti,loans$inq.last.6mths,pch=1,col='pink')
plot(loans$dti,loans$delinq.2yrs,pch=1,col='pink')
plot(loans$dti,loans$pub.rec,pch=1,col='pink')
plot(loans$fico,loans$days.with.cr.line,pch=1,col='pink')
plot(loans$fico,loans$revol.bal,pch=1,col='pink')
plot(loans$fico,loans$revol.util,pch=1,col='pink')
plot(loans$fico,loans$inq.last.6mths,pch=1,col='pink')
plot(loans$fico,loans$delinq.2yrs,pch=1,col='pink')
plot(loans$fico,loans$pub.rec,pch=1,col='pink')
plot(loans$days.with.cr.line,loans$revol.bal,pch=1,col='pink')
plot(loans$days.with.cr.line,loans$revol.util,pch=1,col='pink')
plot(loans$days.with.cr.line,loans$inq.last.6mths,pch=1,col='pink')
plot(loans$days.with.cr.line,loans$delinq.2yr,pch=1,col='pink')
plot(loans$days.with.cr.line,loans$pub.rec,pch=1,col='pink')
plot(loans$revol.bal,loans$revol.util,pch=1,col='pink')
plot(loans$revol.bal,loans$inq.last.6mths,pch=1,col='pink')
plot(loans$revol.bal,loans$delinq.2yr,pch=1,col='pink')
plot(loans$revol.bal,loans$pub.rec,pch=1,col='pink')
plot(loans$revol.util,loans$inq.last.6mths,pch=1,col='pink')
plot(loans$revol.util,loans$delinq.2yr,pch=1,col='pink')
plot(loans$revol.util,loans$pub.rec,pch=1,col='pink')
plot(loans$inq.last.6mths,loans$delinq.2yr,pch=1,col='pink')
plot(loans$inq.last.6mths,loans$pub.rec,pch=1,col='pink')
plot(loans$delinq.2yrs,loans$pub.rec,pch=1,col='pink')
```
>>>>>>> fe57b78a10f8ebd58b427a3528031f5265cc6498
